...
def train():
    ...
    K_epochs = 80               # update policy for K epochs in one DDPG update
    ...
    log_f_name = log_dir + '/DDPG_' + env_name + "_log_" + str(run_num) + ".csv"
    ...
    print("--------------------------------------------------------------------------------------------")
    print("DDPG update frequency : " + str(update_timestep) + " timesteps")
    print("DDPG K epochs : ", K_epochs)
    print("DDPG epsilon clip : ", eps_clip)
    ...
    while time_step <= max_training_timesteps:
        ...
        for t in range(1, max_ep_len+1):
            ...
            ddpg_agent.buffer.is_terminals.append(done)
            ...
            if has_continuous_action_space and time_step % action_std_decay_freq == 0:
                ddpg_agent.decay_action_std(action_std_decay_rate, min_action_std)
            ...
            if time_step % save_model_freq == 0:
                ...
                ddpg_agent.save(checkpoint_path)
                print("model saved")
